...
import { UserInterface, UserStore } from "../../../DataBase";
...
interface RegisterState {
    ...
    getHeaders(): {headers:Headers,user:UserInterface} | undefined
}
export const useRegisterStore = create<RegisterState>((set) => ({
    ...
    async authenticateUser() {
        ...
        if (userJson) {
            ...
            const response = await fetch(`${Host}/can_manage_sublymus`, requestOptions)
